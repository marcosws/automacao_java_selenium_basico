...
public class RodarPaginaDisplay {
	...
	public void executaDisplay() {
		...
		assertTrue(StatusNome.isDisplayed()); // verifica se é exibido na pagina
		...
		assertTrue(StatusEmail.getText().contains("E-mail deve ser preenchido.")); // verifica se contém o texto
